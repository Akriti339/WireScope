...
// #ifndef PLATFORM_H
// #define PLATFORM_H
// Different computers store bytes differently, 
// but network protocols always use the same byte order.
...
#include <cstdint>  
//  needed bcz we need uint16_t, uint32_t, etc. for fixed-size integer types

// Portable byte order conversion
// Works on any platform without requiring system headers
namespace WireScope::Net {

// reverse the bytes of 16 bit number
